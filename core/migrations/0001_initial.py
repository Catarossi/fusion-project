    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado', models.DateField(auto_now=True, verbose_name='Atualização')),
                ('ativo', models.BooleanField(default=True, verbose_name='Ativo')),
                ('servicos', models.CharField(max_length=100, verbose_name='Serviços')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.cargo', verbose_name='Cargo')),
            ],
            options={
